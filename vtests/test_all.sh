...
tests=("BasicTest" "ArithmeticTest" "StringTest" "ConditionalTest" "LoopTest" "ArrayTest" "ComparisonTest" "BooleanTest" "WhileTest" "FunctionTest" "MathTest" "SimpleTypeTest" "RecursionTest" "ArrayLiteralTest")
